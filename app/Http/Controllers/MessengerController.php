...
//        return $messages;
    ...
    function fetchContacts(Request $request)
    {
        $users = Message::join('users', function ($join) {
            ...
            ->groupBy('users.id', 'users.name', 'users.email', 'users.avatar')  // Add all selected columns here
            ->paginate(10);
        ...
        if(count($users) > 0) {
            ...
            $contacts = "<p class='text-center no_contact no_contact'>Your contact list in empty!</p>";
        }
